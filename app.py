...
def add_product():
    if request.method == 'POST':
        ...
        with open('C:/Users/Hp/Desktop/SENTIMENT ANALYSIS/data/dataset.csv', 'a', newline='') as csvfile:
...
def fetch_unique_products_by_category(category):
    ...
    with open('C:/Users/Hp/Desktop/SENTIMENT ANALYSIS/data/dataset.csv', 'r') as csvfile:
